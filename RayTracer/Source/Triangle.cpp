...
bool Triangle::Hit(const ray_t& ray, raycastHit_t& raycastHit, float minDist, float maxDist) {
    float t;
    if (!Raycast(ray, m_v1, m_v2, m_v3, minDist, maxDist, t)) return false;
...
bool Triangle::Raycast(const ray_t& ray, const glm::vec3& v1, const glm::vec3& v2, const glm::vec3& v3, float minDist, float maxDist, float& t) {
    // set edges of the triangle
